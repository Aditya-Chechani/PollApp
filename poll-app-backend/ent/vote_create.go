...
func (_c *VoteCreate) SetVoterIdentifier(v string) *VoteCreate {
	_c.mutation.SetVoterIdentifier(v)
	return _c
}

// SetNillableVoterIdentifier sets the "voter_identifier" field if the given value is not nil.
func (_c *VoteCreate) SetNillableVoterIdentifier(v *string) *VoteCreate {
	if v != nil {
		_c.SetVoterIdentifier(*v)
	}
	return _c
}
...
func (_c *VoteCreate) createSpec() (*Vote, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.VoterIdentifier(); ok {
		_spec.SetField(vote.FieldVoterIdentifier, field.TypeString, value)
		_node.VoterIdentifier = value
	}
